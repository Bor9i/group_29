...
const registrationSearchEngine = users.filter((user) => user.registrationDate === '09.10.2021' || user.registrationDate === '10.10.2021');

console.log(registrationSearchEngine);